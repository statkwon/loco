...
#' @param predict.fun prediction function associated to \eqn{\hat{\mu}}
...
#' @export
loco <- function(X, y, mean.fun, predict.fun, n.train) {
  ...
  Delta = loco_c(X, y, mean.fun, predict.fun, n.train)
  return(Delta)
}
